...
class AttendanceServiceDB:
        ...
        try:
            ...
            for p in participants:
                result.append({
                    ...
                    "attendance_percentage": self._calculate_attendance_percentage(p.id)
                })
            return success_response(
    ...
    def register_public_attendance(self, data):
        """Registrar asistencia desde el frontend (wrapper for bulk)"""
    ...
    def get_session_detail(self, schedule_id, date):
        ...
        try:
            ...
            attendances = Attendance.query.filter_by(schedule_id=schedule.id, date=date).all()
            ...
            for a in attendances:
                result.append({
                    ...
                    "participant": {
                        ...
                        "img": "https://i.pravatar.cc/150?u=" + a.participant.external_id
                    }
                })
    ...
    def delete_session_attendance(self, schedule_id, date):
        ...
        try:
            ...
            return success_response(msg="Registros de asistencia eliminados para la fecha")
        except Exception as e:
            db.session.rollback()
            return error_response(f"Error: {str(e)}")
    ...
    def _calculate_attendance_percentage(self, participant_id):
        ...
        try:
            ...
            if total == 0:
                return 0
            present = Attendance.query.filter_by(participant_id=participant_id, status=Attendance.Status.PRESENT).count()
